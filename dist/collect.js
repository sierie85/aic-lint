...
function readConfigFile(absPath, root) {
...
function readFileIfExists(absPath, root) {
...
export function markdownFiles(config) {
    return [
...
export function allFiles(config) {
...
function isAlwaysOnCursorRule(file) {
    if (file.relPath === ".cursorrules")
        return true;
...
export function alwaysOnFiles(config) {
    return [
        ...config.claudeMdFiles,
        ...compact(config.agentsMd, config.agentsOverrideMd, config.codexAgentsMd, config.geminiMd),
